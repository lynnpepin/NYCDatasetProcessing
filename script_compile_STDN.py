...
fns_v_1 =  ["STDN-volume-2010-01.npz",
...
# Second batch of filenames
fns_f_2 = [ "STDN-flow-2011-10.npz",
...
fns_v_2  = ["STDN-volume-2011-10.npz",
...
for ii, pair in enumerate(((fns_f_1, fns_v_1), (fns_f_2, fns_v_2))):
    fns_f = pair[0]
    fns_v = pair[1]
    ...
    print("Saving to STDN-flow-"+str(ii+1)+".npz")
    np.savez_compressed("data/STDN-flow-"+str(ii+1)+".npz",fdata)
    ...
    print("Saving to STDN-volume-"+str(ii+1)+".npz")
    np.savez_compressed("data/STDN-volume-"+str(ii+1)+".npz",vdata)
